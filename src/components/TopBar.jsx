    ...
    <div className="bg-primary text-white py-2.5 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between text-sm">
        <div className="flex flex-wrap items-center gap-4 md:gap-6">
          ...
          <a href="mailto:info@italyafricavrl.com" className="hidden lg:flex items-center gap-2 hover:text-accent transition-colors">
            <Mail size={14} />
            <span>info@italyafricavrl.com</span>
          </a>
        </div>
